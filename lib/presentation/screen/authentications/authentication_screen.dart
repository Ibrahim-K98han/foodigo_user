...
import '../../../features/restaurant_features/Login/bloc/restaurant_login_event.dart';
...
/// Common form widget used by both User and Restaurant tabs
                    ...
                    return Column(
                      ...
                      children: [
                        CustomFormWidget(
                          ...
                          child: TextFormField(
                            initialValue: state.email,
                            onChanged: (value) => restaurantLoginBloc
                                .add(RestaurantLoginEventUserEmail(value)),
                            decoration: InputDecoration(
                              filled: true,
                              fillColor: const Color(0xffF8FAFC),
                              enabledBorder: OutlineInputBorder(
                  ...
                  builder: (context, state) {
                    return CustomFormWidget(
                      ...
                      child: TextFormField(
                        initialValue: state.password,
                        onChanged: (value) => restaurantLoginBloc
                            .add(RestaurantLoginEventPassword(value)),
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: const Color(0xffF8FAFC),
                          enabledBorder: OutlineInputBorder(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () {
                              restaurantLoginBloc
                                  .add(RestaurantShowPasswordEvent(state.show));
                            },
                            icon: Icon(
                              state.show
                                  ? Icons.visibility_off_outlined
                  ...
                  builder: (context, login) {
                    ...
                    return PrimaryButton(
                      ...
                      onPressed: () {
                        Utils.closeKeyBoard(context);
                        restaurantLoginBloc
                            .add(const RestaurantLoginEventSubmit());
                      },
                    );
                  },
                ),
