...
import 'package:foodigo/features/restaurant_features/OrderStatus/remote/order_status_remote_data_source.dart';
import 'package:foodigo/features/restaurant_features/OrderStatus/repository/order_status_repository.dart';
...
class DInjector {
  ...
  static final repositoryProvider = <RepositoryProvider>[
    ...
    RepositoryProvider<HomeDataRemoteDataSource>(
      create: (context) => HomeDataRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<HomeDataRepository>(
      create:
          (context) => HomeDataRepositoryImpl(remoteDataSource: context.read()),
    ),
    RepositoryProvider<AllRestaurantRemoteDataSource>(
      create:
          (context) =>
              AllRestaurantRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<AllRestaurantRepository>(
      create:
          (context) =>
              AllRestaurantRepositoryImpl(remoteDataSource: context.read()),
    ),
    RepositoryProvider<SingleRestaurantRemoteDataSource>(
      create:
          (context) =>
              SingleRestaurantRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<SingleRestaurantRepository>(
      create:
          (context) =>
              SingleRestaurantRepositoryImpl(remoteDataSource: context.read()),
    ),
    RepositoryProvider<CartRemoteDataSource>(
      create: (context) => CartRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<CartRepository>(
      create: (context) => CartRepositoryImpl(remoteDataSource: context.read()),
    ),
    RepositoryProvider<ProductDetailsRemoteDataSource>(
      create:
          (context) =>
              ProductDetailsRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<ProductDetailsRepository>(
      create:
          (context) =>
              ProductDetailsRepositoryImpl(remoteDataSource: context.read()),
    ),
    ...
    RepositoryProvider<RestaurantLoginRemoteData>(
      create:
          (context) => RestaurantLoginRemoteDataImpl(client: context.read()),
    ),
    RepositoryProvider<RestaurantLoginRepository>(
      create:
          (context) => RestaurantLoginRepositoryImpl(
            remoteDataSources: context.read(),
            localDataSources: context.read(),
          ),
    ),
    ...
    RepositoryProvider<ResDashboardRemoteDataSource>(
      create:
          (context) => ResDashboardRemoteDataSourceImpl(client: context.read()),
    ),
    RepositoryProvider<ResDashboardRepository>(
      create:
          (context) =>
              ResDashboardRepositoryImpl(remoteDataSource: context.read()),
    ),
  ...
  static final blocProvider = <BlocProvider>[
    BlocProvider<HomeDataCubit>(
      create: (context) => HomeDataCubit(repository: context.read()),
    ),
    BlocProvider<AllRestaurantCubit>(
      create: (context) => AllRestaurantCubit(repository: context.read()),
    ),
    BlocProvider<SingleRestaurantCubit>(
      create: (context) => SingleRestaurantCubit(repository: context.read()),
    ),
    BlocProvider<ProductDetailsCubit>(
      create: (context) => ProductDetailsCubit(repository: context.read()),
    ),
